...
HOSP={'III Tunja':POINTS['hosp_tunja_III'],'II La Mesa':POINTS['hosp_lamesa_II'],'I Villa de Leyva':POINTS['hosp_villaleyva_I']}
...
# nearest hospital by level (straight-line proxy)
df['km_nearest_II+']=df[['km_to_III_Tunja','km_to_II_LaMesa']].min(axis=1)
